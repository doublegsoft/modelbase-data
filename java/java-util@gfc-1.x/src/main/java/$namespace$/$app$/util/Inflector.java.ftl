...
public class Inflector {
     ...
     * can be modified by the users via
    ...
    // ------------------------------------------------------------------------------------------------
    /**
     * Returns the plural form of the word in the string. <p> Examples:
     *
     * <pre>
     ...
     * </pre>
     *
     *  <p> Note that if the {@link Object#toString()} is called on the
     * supplied object, so this method works for non-strings, too. 
     *
    ...
    /**
     * Returns the singular form of the word in the string. <p> Examples:
     *
     * <pre>
     ...
     * delimiter characters to identify word boundaries. <p> Examples:
     *
     * <pre>
     ...
     * characters to identify word boundaries. <p> Examples:
     *
     * <pre>
     ...
     * delimiters into underscore. <p> Examples:
     *
     * <pre>
     ...
     * trailing "_id" and any supplied removable tokens. Like {@link #titleCase(String, String[])},
     * this is meant for creating pretty output. <p> Examples:
     *
     * <pre>
    ...
    // ------------------------------------------------------------------------------------------------
    /**
     * Determine whether the supplied word is considered uncountable by the {@link #pluralize(Object) pluralize}
     * and
     ...
     * backreferences. <p> The Java {@link Pattern regular expression processing}
     * does not use the preprocessing directives
     * <code>\l</code>,
     * <code>&#92;u</code>,
     * <code>\L</code>, and
     ...
     * @param input 1
     * @param regex 2
     * @param groupNumberToUppercase 3
