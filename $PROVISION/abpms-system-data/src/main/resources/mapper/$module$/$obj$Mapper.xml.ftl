...
<mapper namespace="com.hk.abpms.data.api.dao.${modelbase.get_object_module(obj)}.${java.nameType(obj.name)}Mapper">
...
<#list obj.attributes as attr>   
  ...
  <select id="select${java.nameType(obj.name)}" parameterType="com.hk.abpms.model.dto.${java.nameVariable(modelbase.get_object_module(obj))}.${java.nameType(obj.name)}Query" 
          resultType="com.hk.abpms.model.entity.${java.nameVariable(modelbase.get_object_module(obj))}.${java.nameType(obj.name)}Entity">
    select 
<#------------->
<#-- 自身属性 -->  
<#------------->    
...
<#list extObjs as extObjName, extRefAttr>
  ...
  <insert id="insert${java.nameType(obj.name)}" parameterType="com.hk.abpms.model.entity.${java.nameVariable(modelbase.get_object_module(obj))}.${java.nameType(obj.name)}Entity">
...
<#list nonIdAttrs as attr>
  ...
  <update id="update${java.nameType(obj.name)}" parameterType="com.hk.abpms.model.entity.${java.nameVariable(modelbase.get_object_module(obj))}.${java.nameType(obj.name)}Entity">
...
<#list idAttrs as attr>
  ...
  <update id="updatePartial${java.nameType(obj.name)}" parameterType="com.hk.abpms.model.entity.${java.nameVariable(modelbase.get_object_module(obj))}.${java.nameType(obj.name)}Entity">
    update ${obj.persistenceName} set
<#list nonIdAttrs as attr>
    <if test="${java.nameVariable(attr.name)} != null">
  <#if attr.type.custom>  
...
<#list idAttrs as attr>
  ...
  <delete id="delete${java.nameType(obj.name)}" parameterType="com.hk.abpms.model.entity.${java.nameVariable(modelbase.get_object_module(obj))}.${java.nameType(obj.name)}Entity">
