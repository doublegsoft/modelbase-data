...
<#list model.objects as obj>
  ...
  <![CDATA[
    select <#list idAttrs as attr>${modelbase.get_object_sql_alias(obj)}.${attr.persistenceName} as ${modelbase.get_attribute_sql_name(attr)},</#list>
