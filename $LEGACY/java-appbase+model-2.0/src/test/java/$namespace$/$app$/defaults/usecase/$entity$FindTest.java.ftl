 ...
 * @since ${version}
 */
public class ${java.nameType(entity.name)}FindTest {
  ...
  public void test_script() throws Exception {
    System.out.println("############## ${java.nameType(entity.name)}FindTest -- script");
    ...
    JsonData data = groovyService.execute("${parentApplication}/${app.name}/${entity.name}/find", params);
