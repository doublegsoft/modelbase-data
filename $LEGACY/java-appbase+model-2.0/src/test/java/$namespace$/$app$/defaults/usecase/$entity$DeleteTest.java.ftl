 ...
 * @since ${version}
 */
public class ${java.nameType(entity.name)}DeleteTest {
  ...
  public void test_usecase() throws Exception {
    System.out.println("############## ${java.nameType(entity.name)}DeleteTest");
    ...
    data = (${java.nameType(entity.name)}) repositoryService.handleUsecase("${parentApplication}/${app.name}/${entity.name}/delete", params);
    System.out.println(new JsonData().set("data", data));
  }
