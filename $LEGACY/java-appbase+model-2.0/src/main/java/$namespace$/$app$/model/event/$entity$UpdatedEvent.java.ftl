 ...
 * @since 1.0.0
 */
public class ${java.nameType(entity.name)}UpdatedEvent implements Event<${java.nameType(entity.name)}>, Serializable {

  private static final long serialVersionUID = -1L;
  
  private static final String EVENT_NAME = "${parentApplication}/${app.name}/${entity.name}/updated";
