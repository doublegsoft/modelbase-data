...
<#list value.attributes as attr>
  ...
  <#elseif attr.type.custom>
    <#assign objAttrType = model.findObjectByName(attr.type.name)>
    ...
    <#if objAttrType.isLabelled('entity')>
      <#assign refObjId = modelbase.get_id_attributes(objAttrType)[0]>
    String ${java.nameVariable(attr.name)}ObjectId = params.get("${java.nameVariable(attr.name)}${java.nameType(modelbase.get_attribute_sql_name(refObjId))}");
    if (!Strings.isBlank(${java.nameVariable(attr.name)}ObjectId)) {
      ${java.nameType(attr.type.name)} ${java.nameVariable(attr.type.name)} = new ${java.nameType(attr.type.name)}();
      ${java.nameVariable(attr.type.name)}.setId(${java.nameVariable(attr.name)}ObjectId);
      retVal.set${java.nameType(attr.name)}(${java.nameVariable(attr.type.name)});
    }
    ${java.nameVariable(attr.name)}ObjectId = params.get("${modelbase.get_attribute_sql_name(attr)}");
    if (!Strings.isBlank(${java.nameVariable(attr.name)}ObjectId)) {
      ${java.nameType(attr.type.name)} ${java.nameVariable(attr.type.name)} = new ${java.nameType(attr.type.name)}();
      ${java.nameVariable(attr.type.name)}.setId(${java.nameVariable(attr.name)}ObjectId);
      retVal.set${java.nameType(attr.name)}(${java.nameVariable(attr.type.name)});
    ...
    <#else>
    String ${java.nameVariable(attr.name)}ObjectId = params.get("${modelbase.get_attribute_sql_name(attr)}");
    if (!Strings.isBlank(${java.nameVariable(attr.name)}ObjectId)) {
      ${java.nameType(attr.type.name)} ${java.nameVariable(attr.type.name)} = new ${java.nameType(attr.type.name)}();
      ${java.nameVariable(attr.type.name)}.setCode(${java.nameVariable(attr.name)}ObjectId);
      retVal.set${java.nameType(attr.name)}(${java.nameVariable(attr.type.name)});
    }
    </#if>
  <#elseif attr.type.name == 'json'>
