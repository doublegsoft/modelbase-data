...
<project xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  <properties>
    ...
    <appbase.version>5.0</appbase.version>
  </properties>
  ...
  <dependencyManagement>
    <dependencies>
      <dependency>
        ...
        <version>${r"${appbase.version}"}</version>
        <scope>import</scope>
        <type>pom</type>
      </dependency>
    </dependencies>
  ...
  <build>
    <finalName>${r"${project.artifactId}"}-${r"${project.version}"}.${r"${maven.build.timestamp}"}</finalName>
    <plugins>
      <plugin>
...
<#list dependencies![] as dep>
    ...
    <dependency>
      ...
      <artifactId>${depObj[1]}</artifactId>
    ...
    <dependency>
      <groupId>net.doublegsoft.appbase</groupId>
      <artifactId>appbase-graph</artifactId>
      <version>5.0</version>
    </dependency>
