...
stdbiz.${app.name}.merge${js.nameType(obj.name)} = function (data, resolve) {
  xhr.post({
    url: '/api/v3/common/script/stdbiz/${app.name}/${obj.name}/merge',
    data: data,
    success: function(resp) {
      if (resp.error) {
        dialog.error(resp.error.message);
...
stdbiz.${app.name}.read${js.nameType(obj.name)} = function (params, resolve) {
  xhr.post({
...
stdbiz.${app.name}.find${js.nameType(obj.plural)} = function (data, resolve) {
  xhr.post({
    url: '/api/v3/common/script/stdbiz/${app.name}/${obj.name}/<#if obj.isLabelled('entity')>find<#else>get</#if>',
    data: data,
    success: function(resp) {
      if (resp.error) {
        dialog.error(resp.error.message);
...
stdbiz.${app.name}.delete${js.nameType(obj.name)} = function (model, resolve) {
  var params = {};
  <#list attrIds as attrId>
  params.${modelbase.get_attribute_sql_name(attrId)} = model.${modelbase.get_attribute_sql_name(attrId)};
  </#list>
  ...
  xhr.post({
    url: '/api/v3/common/script/stdbiz/${app.name}/${obj.name}/delete',
    data: params,
    success: function(resp) {
      if (resp.error) {
        dialog.error(resp.error.message);
...
stdbiz.${app.name}.exclude${js.nameType(obj.name)} = function (data, resolve) {
  xhr.post({
    url: '/api/v3/common/script/stdbiz/${app.name}/${obj.name}/exclude',
    data: data,
    success: function(resp) {
      if (resp.error) {
        dialog.error(resp.error.message);
...
stdbiz.${app.name}.reorder${js.nameType(obj.name)} = function (data, resolve) {
  xhr.post({
    url: '/api/v3/common/script/stdbiz/${app.name}/${obj.name}/reorder',
    data: data,
    success: function(resp) {
      if (resp.error) {
        dialog.error(resp.error.message);
...
stdbiz.${app.name}.link${js.nameType(obj.name)} = function (data, resolve) {
  xhr.post({
    url: '/api/v3/common/script/stdbiz/${app.name}/${obj.name}/link',
    usecase: '',
    data: data,
    success: function(resp) {
      if (resp.error) {
...
// 连接【${modelbase.get_object_label(obj)}】对象
stdbiz.${app.name}.unlink${js.nameType(obj.name)} = function (data, resolve) {
  xhr.post({
    url: '/api/v3/common/script/stdbiz/${app.name}/${obj.name}/unlink',
    usecase: '',
    data: data,
    success: function(resp) {
      if (resp.error) {
...
stdbiz.${app.name}.add${js.nameType(obj.name)} = function (data, resolve) {
  xhr.post({
    url: '/api/v3/common/script/stdbiz/${app.name}/${obj.name}/add',
    data: data,
    success: function(resp) {
      if (resp.error) {
        dialog.error(resp.error.message);
...
stdbiz.${app.name}.remove${js.nameType(obj.name)} = function (model, resolve) {
  xhr.post({
    url: '/api/v3/common/script/stdbiz/${app.name}/${obj.name}/remove',
    data: {
  <#list attrIds as attrId>
...
stdbiz.${app.name}.get${js.nameType(obj.plural)} = function (data, resolve) {
  xhr.post({
    url: '/api/v3/common/script/stdbiz/${app.name}/${obj.name}/get',
    data: data,
    success: function(resp) {
      if (resp.error) {
        dialog.error(resp.error.message);
...
stdbiz.${app.name}.enableStateOf${js.nameType(obj.name)} = function (model, resolve) {
  xhr.post({
    url: '/api/v3/common/script/stdbiz/${app.name}/${obj.name}/save',
    data: {
  <#list attrIds as attrId>
...
stdbiz.${app.name}.disableStateOf${js.nameType(obj.name)} = function (model, resolve) {
  xhr.post({
    url: '/api/v3/common/script/stdbiz/${app.name}/${obj.name}/save',
    data: {
  <#list attrIds as attrId>
...
stdbiz.${app.name}.load${js.nameType(attr.name)}${js.nameType(obj.name)} = function(data, resolve) {
  xhr.post({
    url: '/api/v3/common/script/stdbiz/${app.name}/${attr.type.name}/find',
    data: data,
    success: function (resp) {
      if (resp.error) {
        dialog.error(resp.error.message);
...
stdbiz.${app.name}.option${js.nameType(obj.name)} = function (params, complete) {
  xhr.post({
    url: '/api/v3/common/script/stdbiz/uxd/custom_element/read',
    data: {
